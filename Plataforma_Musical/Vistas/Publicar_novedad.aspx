<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/Pagina_Maestra.Master" AutoEventWireup="true" CodeBehind="Publicar_novedad.aspx.cs" Inherits="Plataforma_Musical.Vistas.Publicar_novedad" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="height: 300px">
        <div style="width: 229px; height: 28px; margin-left: 582px">
            <asp:Button ID="btnpublicar" runat="server" Text="Publicar" Width="225px" OnClick="btnpublicar_Click" />
        </div>
    </div>
